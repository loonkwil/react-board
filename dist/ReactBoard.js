...
function range(start, end) {
  ...
  return Array.from(new Array(length)).map(function (_, i) {
    return start + i;
  });
}
/**
...
var letters = range('a'.charCodeAt(), 'z'.charCodeAt()).map(function (code) {
...
function getColName(col) {
  ...
  return getColName(Math.floor(col / letters.length) - 1) + getColName(col % letters.length);
}
/**
 * @param {number} row
 * @return {string}
...
var _ReactBoardRow = _interopRequireDefault(__webpack_require__(13));
...
function ReactBoard(_ref) {
  ...
  var rows = (0, _utils.range)(0, height - 1).map(function (rowIndex) {
    var valuesInOneRow = (0, _utils.range)(0, width - 1).map(function (colIndex) {
    ...
    return _react.default.createElement(_ReactBoardRow.default, {
      key: rowIndex,
      row: rowIndex,
      size: width,
  ...
  return _react.default.createElement("div", {
    className: "react-board"
  }, rows);
}

ReactBoard.propTypes = {
  /* Size of the board */
  size: _propTypes.default.oneOfType([_propTypes.default.number, _propTypes.default.arrayOf(_propTypes.default.number)]).isRequired,
   ...
   * ]
   */
  values: _propTypes.default.arrayOf(_propTypes.default.array),
...
var _ReactBoardCell = _interopRequireDefault(__webpack_require__(14));
...
function (_React$Component) {
  ...
  function ReactBoardRow() {
    ...
    return _possibleConstructorReturn(this, (ReactBoardRow.__proto__ || Object.getPrototypeOf(ReactBoardRow)).apply(this, arguments));
  }

  _createClass(ReactBoardRow, [{
    key: "shouldComponentUpdate",
    value: function shouldComponentUpdate(nextProps) {
      return !(0, _utils.arrayEq)(this.props.values, nextProps.values) || !(0, _utils.arrayEq)(this.props.highlight, nextProps.highlight) || this.props.size !== nextProps.size || this.props.clickHandler !== nextProps.clickHandler;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var cells = (0, _utils.range)(0, this.props.size - 1).map(function (col) {
        var isHighlighted = _this.props.highlight.indexOf(col) >= 0;
        return _react.default.createElement(_ReactBoardCell.default, {
          key: col,
          row: _this.props.row,
          col: col,
...
ReactBoardRow.propTypes = {
  ...
  highlight: _propTypes.default.arrayOf(_propTypes.default.number),
  clickHandler: _propTypes.default.func
};
...
function (_React$Component) {
  ...
  function ReactBoardCell() {
    ...
    return _possibleConstructorReturn(this, (ReactBoardCell.__proto__ || Object.getPrototypeOf(ReactBoardCell)).apply(this, arguments));
  }
  ...
  _createClass(ReactBoardCell, [{
    ...
    value: function render() {
      ...
      var cellName = (0, _utils.getCellName)(this.props.col, this.props.row);
...
ReactBoardCell.propTypes = {
  ...
  value: function value(props, propName) {
    ...
    if (value !== null && validTypes.indexOf(_typeof(value)) === -1) {
      var msg = 'The value of the cell should be a primitive value ' + "(null, ".concat(validTypes.join(', '), ")!");
